...
class FlutterPainterExampleState extends State<FlutterPainterExample> {
  ...
  static const List<String> imageLinks = [
    "https://pluspng.com/img-png/hearts-png-hd-hearts-png-hd-pluspng-com-5000-hearts-png-hd-5000.png",
    "https://pluspng.com/img-png/hearts-png-hd-download-png-image-heart-png-hd-2435-999.png",
  ];
  ...
  void initBackground() async {
    ...
    final image = await const NetworkImage(
            'https://pluspng.com/img-png/png-frames-for-pictures-flowers-frame-colours-759.png')
        .image;
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: ValueListenableBuilder<PainterControllerValue>(
            ...
            child: const Text("HandWriting Note"),
      ...
      body: Stack(
        children: [
          // 背景
          if (backgroundImage != null || !isImageBackground)
