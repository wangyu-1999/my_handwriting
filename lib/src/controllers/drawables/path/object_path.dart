...
import '../shape/shape_drawable.dart';
import '../sized1ddrawable.dart';
import '../../../extensions/paint_copy_extension.dart';

/// A drawable of a Path
class ObjectPathDrawable extends Sized1DDrawable implements ShapeDrawable {
  ...
  /// Creates a new [ObjectPathDrawable] with the given [length], [paint] and [arrowHeadSize].
  ObjectPathDrawable({
    Paint? paint,
    this.arrowHeadSize,
